 ...
 * @author clement
 */
public final class DummyRecon2v02 implements DummySbml {
	public static final String sbmlPath = "recon2v02.xml";
	...
	private final int NUMBER_OF_REFS = 18483;
	...
	public DummyRecon2v02() {
		...
		dummyE.addRef("inchikey", "IJFLXRCJWPKGKJ-LXIXEQKWSA-N", 1, "is", "sbml file");
