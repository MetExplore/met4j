...
public class JSBMLUtils {
	 ...
	 */
	public static final String defaultProp = "log4j.rootCategory=ERROR, stdout\n"
			+ "log4j.logger.org.sbml= stdout\n"
			+ "#\n"
			+ "# Console Display\n"
			+ "#\n"
	 ...
	 * 
	 * @param lev
	 *            the level from which Log4j will start logging messages
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if an error occurred when reading our default configuration
	 *             as an input stream
	 */
	 ...
	 *            the property and its value to set/ update
	 * @throws IOException
	 *             if an error occurred when reading the input as an input
	 *             stream
	 */
	...
	public static void addFileLog(String logFilePath) {
		...
		Logger.getLogger("org.sbml").addAppender(appender);
	}
